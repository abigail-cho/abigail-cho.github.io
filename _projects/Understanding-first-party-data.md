...
A conceptual article explaining what first-party data is and how it was used to an influencer's benefit when they connected their social network accounts to the company, GRIN. It was assumed that most influencers were not familiar with first-party data at all, and that they were cautious about giving away first-party data because they didn't know what that entailed. This article aimed to demystify first-party data and convince influencers they should give first-party permissions to GRIN. 
